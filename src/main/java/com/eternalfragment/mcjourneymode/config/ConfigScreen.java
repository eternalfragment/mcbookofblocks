...
public class ConfigScreen {
    ...
    public static void buildScreen() {
        ...
        general.addEntry(entryBuilder.startStringDropdownMenu(Text.translatable("mjm.config.menu.researchable"), "1 - "+Text.translatable("mjm.config.menu.research.pay").getString())
                ...
                .build());
        //Research Amount
        general.addEntry(entryBuilder.startIntField(Text.translatable("mjm.config.menu.resAmt"), 512)
                .setDefaultValue(512)
                .setSaveConsumer(result->addReqAmt.set(result))
                .build());
        //Give Amount
        general.addEntry(entryBuilder.startIntSlider(Text.translatable("mjm.config.menu.giveAmt"), 64,1,64)
                .setDefaultValue(64)
                .setSaveConsumer(result->addGiveAmt.set(result))
                .build());
        //Scoreboard Objective
        general.addEntry(entryBuilder.startStrField(Text.translatable("mjm.config.menu.scbName"),"")
                .setDefaultValue("")
                .setSaveConsumer(result->addScbObj.set(result))
                .build());
        //Scoreboard Amount
        general.addEntry(entryBuilder.startIntField(Text.translatable("mjm.config.menu.scbGoal"), 0)
                .setDefaultValue(0)
